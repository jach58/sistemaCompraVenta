          ...
          <div class="card">
              ...
              <div class="card-body">
                  ...
                  <table class="table table-bordered table-striped table-sm">
                      ...
                      <tbody>
                          <tr v-for="persona of arrayPersona" :key="persona.id">
                              <td>
                                  <button type="button" 
                                    @click="abrirModal('persona', 'actualizar', persona)" class="btn btn-warning btn-sm">
                  ...
                  <nav>
                      <ul class="pagination">
                          ...
                          <li class="page-item" v-for="page of pagesNumber" :key="page" :class="[page == isActived ? 'active' : '']">
                  ...
                  <div class="modal-body">
                      <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                          ...
                          <div class="form-group row">
                              ...
                              <div class="col-md-9">
                                  <select v-model="tipo_documento" class="form-control-label" for="text-input">
                          ...
                          <div class="form-group row">
                              ...
                              <div class="col-md-9">
                                  <input type="text" v-model="telefono" class="form-control" placeholder="Télefono">
                              </div>
                          </div>
                          <div class="form-group row">
                          ...
                          <div v-show="errorPersona" class="form-group row div-error">
                            <div class="text-center text-error">
                              <div v-for="error of errorMostrarMsjPersona" :key="error" v-text="error"></div>
                            </div>
                          </div>
                      </form>
                  </div>
...
export default {
  ...
  computed: {
    ...
    //Calculas los elementos de la paginacion
  ...
  methods: {
    ...
    registrarPersona() {
      ...
      axios.post('/proveedor/registrar',{
        ...
        'num_documento': this.tipo_documento,
